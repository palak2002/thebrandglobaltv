            ...
            <div className={styles.cardnftCardlargedarkParent}>
                ...
                <div className={styles.maskGroupParent}>
                  ...
                  <div className={styles.nftNameParent}>
                    <div className={styles.topSellers}>
                      grey-vincent-van-gogh-1TlJ
                    </div>
                    <div className={styles.groupParent4}>
                      <div className={styles.parent3}>
                        <div className={styles.div10}>{`1.25 `}</div>
              ...
              <div className={styles.cardnftCardlargedark}>
                ...
                <div className={styles.maskGroupParent}>
                  ...
                  <div className={styles.nftNameParent}>
                    <div
                      className={styles.topSellers}
                    >{`paintings artwork johannes `}</div>
                    <div className={styles.groupParent5}>
                      <div className={styles.parent4}>
                        <div className={styles.div10}>{`0.20 `}</div>
                        <div className={styles.eth6}>ETH</div>
                      </div>
              ...
              <div className={styles.cardnftCardlargedark}>
                ...
                <div className={styles.maskGroupParent}>
                  ...
                  <div className={styles.nftNameParent}>
                    <div className={styles.topSellers}>
                      pexels-photo-12215778
                    </div>
                    <div className={styles.groupParent5}>
                      <div className={styles.parent4}>
                        <div className={styles.div10}>{`0.87 `}</div>
                        <div className={styles.eth6}>ETH</div>
                      </div>
                      <div className={styles.groupFrame}>
                        <div className={styles.frameContainer}>
            ...
            <div className={styles.cardnftCardlargedarkParent}>
              <div className={styles.cardnftCardlargedark}>
                ...
                <div className={styles.maskGroupParent}>
                  ...
                  <div className={styles.nftNameParent}>
                    ...
                    <div className={styles.groupParent5}>
                      <div className={styles.parent5}>
                        <div className={styles.div10}>{`0.09 `}</div>
                        <div className={styles.eth7}>ETH</div>
                      </div>
              ...
              <div className={styles.cardnftCardlargedark}>
                ...
                <div className={styles.maskGroupParent}>
                  ...
                  <div className={styles.nftNameParent}>
                    <div className={styles.topSellers}>
                      pexels-photo-14411572
                    </div>
                    <div className={styles.groupParent4}>
                      <div className={styles.parent5}>
                        <div className={styles.div10}>{`0.90 `}</div>
                        <div className={styles.eth7}>ETH</div>
                      </div>
              ...
              <div className={styles.cardnftCardlargedark}>
                ...
                <div className={styles.maskGroupParent}>
                  ...
                  <div className={styles.nftNameParent}>
                    <div className={styles.topSellers}>
                      pexels-photo-10322846
                    </div>
                    <div className={styles.groupParent5}>
                      <div className={styles.parent4}>
                        <div className={styles.div10}>{`0.52 `}</div>
                        <div className={styles.eth6}>ETH</div>
                      </div>
                      <div className={styles.groupFrame}>
                        <div className={styles.frameContainer}>
              ...
              <div className={styles.cardnftCardlargedark}>
                ...
                <div className={styles.maskGroupParent}>
                  ...
                  <div className={styles.nftNameParent}>
                    ...
                    <div className={styles.groupParent6}>
                      <div className={styles.parent5}>
                        <div className={styles.div10}>{`0.85 `}</div>
                        <div className={styles.eth7}>ETH</div>
                      </div>
                      <div className={styles.groupWrapper1}>
                        <div className={styles.frameWrapper2}>
          ...
          <div className={styles.col1Parent}>
            <div className={styles.col1}>
              ...
              <div className={styles.vectorParent}>
                <input className={styles.rectangleInput} type="email" />
